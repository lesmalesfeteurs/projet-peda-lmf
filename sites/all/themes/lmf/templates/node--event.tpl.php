...
<div id="activite">
	<?php
		if((!$logged_in || $user->roles[14] || $user->roles[13]) && $node->field_public_event["und"][0]['value'] == "privée") :
			...
			print render($content['field_temps_de_r_traction']);
			print render($content['field_site_web']);
			print render($content['body']);
		endif;

		if(!$logged_in): 
	?>
	<div id="connect-read-more">
		<p>Pour en savoir plus, vous devez être sympathisant. <a href="<?php print $base_url;?>/lmf/user/register" title="S'inscrire">Inscrivez-vous !</a></p>
	</div>
	...
	<?php
			...
			// TODO set order
				// ADD PICTURES
			print render($content['field_address_ref']);
			print render($content['links']);
			//print render($content['field_public_event']);
		endif;

		if(!(!$logged_in || $user->roles[14] || $user->roles[13])):
